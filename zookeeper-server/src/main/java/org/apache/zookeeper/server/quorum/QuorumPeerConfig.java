    ...
    public void parseProperties(Properties zkProp) throws IOException, ConfigException {
        ...
        for (Entry<Object, Object> entry : zkProp.entrySet()) {
            ...
            if (key.equals("dataDir")) {
                ...
                localSessionsEnabled = parseBoolean(value);
            } else if (key.equals("localSessionsUpgradingEnabled")) {
                localSessionsUpgradingEnabled = parseBoolean(value);
                ...
                quorumListenOnAllIPs = parseBoolean(value);
                ...
                syncEnabled = parseBoolean(value);
                ...
                setStandaloneEnabled(parseBoolean(value));
            } else if (key.equals("reconfigEnabled")) {
                setReconfigEnabled(parseBoolean(value));
            } else if (key.equals("sslQuorum")) {
                sslQuorum = parseBoolean(value);
            } else if (key.equals("portUnification")) {
                shouldUsePortUnification = parseBoolean(value);
            } else if (key.equals("sslQuorumReloadCertFiles")) {
                sslQuorumReloadCertFiles = parseBoolean(value);
                ...
                quorumEnableSasl = parseBoolean(value);
            } else if (key.equals(QuorumAuth.QUORUM_SERVER_SASL_AUTH_REQUIRED)) {
                quorumServerRequireSasl = parseBoolean(value);
            } else if (key.equals(QuorumAuth.QUORUM_LEARNER_SASL_AUTH_REQUIRED)) {
                quorumLearnerRequireSasl = parseBoolean(value);
                ...
                jvmPauseMonitorToRun = parseBoolean(value);
                ...
                multiAddressEnabled = parseBoolean(value);
                ...
                multiAddressReachabilityCheckEnabled = parseBoolean(value);
            } else {
    ...
    private boolean parseBoolean(String value) throws ConfigException {
        if (value.equalsIgnoreCase("true")) {
            ...
            throw new ConfigException("Invalid option "
                                      + value
                                      + " for boolean flag. Choose 'true' or 'false.'");
        }
    }
}
