...
public class QuorumPeerMainTest extends QuorumPeerTestBase {
    ...
    public void testDivergenceResync() throws Exception {
        ...
        Assert.assertTrue("There should be a leader", leader >= 0);
        Assert.assertTrue("There should be a leader", leader == srvA);
        svrs.mt[srvA].shutdown();
        svrs.mt[srvC].shutdown();
        waitForAll(svrs.zk, States.CONNECTING);
        ...
        Assert.assertEquals("Expecting the value of the 1st key on 1st and 2nd servers should be same", outputAKey1, outputBKey1);
        Assert.assertEquals("Expecting the value of the 1st key on 2nd and 3rd servers should be same", outputBKey1, outputCKey1);
        Assert.assertEquals("Expecting the value of the 2nd key on 1st and 2nd servers should be same", outputAKey2, outputBKey2);
        Assert.assertEquals("Expecting the value of the 2nd key on 2nd and 3rd servers should be same", outputBKey2, outputCKey2);
